...
//    pose.orientation.z = 0.5;
    ...
    tf::Quaternion q1 = tf::createQuaternionFromRPY(fRand(0.0,2*M_PI), 0.0 ,fRand(0,2*M_PI)); //check more rotation around y-axis
...
//    pose1.orientation.z = 0.0;
    ...
    tf::Quaternion q2 = tf::createQuaternionFromRPY(fRand(0.0,2*M_PI), 0.0 ,fRand(0,2*M_PI)); //check more rotation around y-axis
...
//    pose2.orientation.z = 0.0;
    ...
    moveit_msgs::CollisionObject cylinder = akit.addCollisionCylinder(pose2, "cuboid",CYLINDER_HEIGHT,CYLINDER_RADIUS);
